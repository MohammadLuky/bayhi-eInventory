...
<head>
    ...
    <link rel="icon" href="<?= base_url('assets/') ?>admin2/images/aset_atk.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" href="<?= base_url('assets/admin_lte/') ?>dist/css/mystyle.css">
    <link rel="stylesheet" href="<?= base_url('assets/admin_lte/') ?>plugins/toastr/toastr.min.css">
    <style>
        .fa-spin {
