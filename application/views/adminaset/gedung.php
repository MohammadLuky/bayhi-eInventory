                ...
                <div class="col-md-12">
                    ...
                    <div class="col-lg-6">
                        <div class="card card-lightblue shadow">
                            ...
                            <form action="<?= base_url('adminaset/gedung'); ?>" method="post">
                                <div class="card-body">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-12">
    ...
    <div class="modal fade edit_gedung<?= $g['id_gedung']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="<?= base_url('adminaset/edit_gedung/') . $g['id_gedung']; ?>" method="post">
    ...
    <div id="hapus_gedung<?= $g['id_gedung']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="hapus_gedungTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('adminaset/hapus_gedung/') . $g['id_gedung']; ?>" method="post">
                    <div class="modal-body">
