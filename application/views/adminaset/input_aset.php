                ...
                <div class="col-md-12">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-auto mr-auto">
                                        ...
                                        <a href="<?= base_url('adminaset/DownloadFormatAset'); ?>" class="badge bg-info"> Download Format Import Aset</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <?= form_open_multipart('adminaset/upload_InputDataAset'); ?>
                                <div class="row">
                                    <div class="col-sm-12">
                    ...
                    <div class="col-12">
                        <div class="card card-outline card-olive shadow">
                            <form action="<?= base_url('adminaset/input_aset'); ?>" method="post">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-auto mr-auto">
                                            <h5>Input Aset</h5>
                                        ...
                                        <div class="col-auto">
                                            <a href="<?= base_url('adminaset/hasil_input_aset'); ?>" type="button" class="btn btn-block bg-gradient-dark btn-sm"><i class="fas fa-list-alt"></i> Hasil Inputan</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
