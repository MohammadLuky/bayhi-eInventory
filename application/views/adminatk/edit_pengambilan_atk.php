                ...
                <div class="col-md-12">
                    ...
                    <div class="col-12">
                        <div class="card card-outline card-olive shadow">
                            <form action="<?= base_url('adminatk/edit_pengambilanATK/') . $getPengambilanATK['id_pengambilan']; ?>" method="post">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <a href="<?= base_url('adminatk/input_pengambilanATK/') . $getPengambilanATK['unit_pengambilan_id']; ?>" type="button" class="btn bg-gradient-dark btn-sm"><i class="fas fa-list-alt"></i> ATK Pengambilan <?= $getPengambilanATK['nama_unit']; ?></a> |
