                        ...
                        <div class="card card-olive shadow ">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <a href="<?= base_url('adminatk/input_pengajuanATK'); ?>" type="button" class="btn btn-block bg-gradient-dark btn-sm">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php else : ?>
                                                    <td class="text-center">
                                                        <a href="<?= base_url('adminatk/edit_pengajuanATK/') . $pengajuanATK['id_pengajuan'] ?>" class="badge bg-warning"><i class="far fa-edit"></i> Edit
                                                        </a> |
    ...
    <div id="hapus_pengajuanATK<?= $pengajuanATK['id_pengajuan']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="hapus_pengajuanATK" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('adminatk/hapus_pengajuanATK/') . $pengajuanATK['id_pengajuan']; ?>" method="post">
                    <div class="modal-body">
                        <input type="hidden" value="<?= $pengajuanATK['id_pengajuan']; ?>">
