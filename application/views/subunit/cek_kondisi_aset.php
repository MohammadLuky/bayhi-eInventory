                    ...
                    <div class="card card-lightblue shadow">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <a href="<?= base_url('subunit/kondisi_aset'); ?>" type="button" class="btn  btn-block bg-gradient-dark btn-sm"><i class="fas fa-step-backward"></i> Kembali</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="<?= base_url('subunit/cek_kondisi_aset/') . $get_aset['id_input_aset']; ?>" method="post">
                            ...
                            <div class="card card-olive shadow">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <a href="<?= base_url('subunit/laporanKondisi/') . $get_aset['id_input_aset']; ?>" class="btn bg-gradient-dark btn-block btn-sm"><i class="fas fa-file-pdf"></i> Cetak Laporan</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
    ...
    <div id="hapus_kondisi<?= $kpa['id_kondisi']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="hapus_kondisi" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('subunit/hapus_kondisi/') . $kpa['id_kondisi']; ?>" method="post">
