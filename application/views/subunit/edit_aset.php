                ...
                <div class="col-md-12">
                    ...
                    <div class="col-12">
                        <div class="card card-outline card-olive shadow">
                            <form action="<?= base_url('subunit/edit_aset/') . $get_aset['id_input_aset']; ?>" method="post">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <a href="<?= base_url('subunit/hasil_input_aset'); ?>" type="button" class="btn btn-block bg-gradient-dark btn-sm"><i class="fas fa-list-alt"></i> Hasil Inputan</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="aset_sub_unit" id="aset_sub_unit" disabled style="width: 100%;">
                                                    ...
                                                    <?php foreach ($sub_unit as $sb) : ?>
                                                        ...
                                                        <option value="<?= $sb['id_sub_unit']; ?>" data-value1="<?= $sb['gedung_sub_unit_id']; ?>" data-value2="<?= $sb['unit_id']; ?>" data-value3="<?= $sb['ruang_sub_unit_id']; ?>" data-value4="<?= $sb['subunit_pic_id']; ?>" data-value5="<?= $sb['nama']; ?>" data-value6="<?= $sb['nama_unit']; ?>" selected>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="namaPIC" name="namaPIC" value="<?= $get_aset['nama'];?>" readonly>
                                                <p><code>Hanya bisa diubah di menu mutasi aset.</code></p>
                                                <input type="hidden" class="form-control" id="value_aset_input4" name="value_aset_input4" placeholder="Nama PIC">
                                                <input type="hidden" class="form-control" id="namaUnit" name="namaUnit" placeholder="Nama Unit">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="jenis_aset_id_text" id="jenis_aset_id_text" value="<?= $get_aset['jenis_kelompok_id'];?>">
