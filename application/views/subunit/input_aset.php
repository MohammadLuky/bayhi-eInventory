                ...
                <div class="col-md-12">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-auto mr-auto">
                                        ...
                                        <a href="<?= base_url('subunit/DownloadFormatAset'); ?>" class="badge bg-info"> Download Format Import Aset</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <?= form_open_multipart('subunit/upload_InputDataAset'); ?>
                                <div class="row">
                                    <div class="col-sm-12">
                    ...
                    <div class="col-12">
                        <div class="card card-outline card-olive shadow">
                            <form action="<?= base_url('subunit/input_aset'); ?>" method="post">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-auto mr-auto">
                                            <h5>Input Aset</h5>
