                        ...
                        <div class="card card-olive shadow ">
                            <div class="card-header">
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <table class="table table-sm">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php if ($getUnit['status_pengajuan'] == 'revisi' || $getUnit['status_pengajuan'] == 'pengajuan' || $getUnit['status_pengajuan'] == 'approval') : ?>
                                                        <tr>
                                                            <td>Status Pengajuan</td>
                                                            <td>:</td>
                                                            <td><strong><em><?= $getUnit['status_pengajuan']; ?></em></strong></td>
                                                        </tr>
                                                    <?php endif; ?>
                                                    <tr>
                                                        <td colspan="3"></td>
                                    ...
                                    <div class="col-auto">
                                        <!-- <a href="<?= base_url('subunit/DataValidasiPengajuanATK'); ?>" type="button" class="btn bg-gradient-dark btn-sm"><i class="fas fa-step-backward"></i> Kembali</a> -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <?php if ($getUnit['status_pengajuan'] == 'approval') : ?>
                                            <a href="<?= base_url('subunit/cetakExcelPengajuanATKUnit/') . $getUnit['id_unit']; ?>" type="button" class="btn bg-gradient-orange btn-sm"><i class="fas fa-print"></i> Cetak Pengajuan</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="proses_pengajuan<?= $ATKunit['id_unit']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="proses_pengajuan" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('subunit/prosesPengajuan/') . $getUnit['id_unit']; ?>" method="post">
