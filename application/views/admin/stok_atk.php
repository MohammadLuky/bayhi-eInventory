                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a href="<?= base_url('admin/pembelianATK') ?>" class="text-dark btn bg-gradient-warning btn-sm"><i class="far fa-list-alt"></i> Riwayat Pembelian ATK</a>
                                        <!-- <a href="<?= base_url('admin/atk') ?>" class="text-dark btn bg-gradient-warning btn-sm"><i class="far fa-list-alt"></i> Daftar Barang ATK</a> -->
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
...
<div class="modal fade beli_stok_atk" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="<?= base_url('admin/stokATK'); ?>" method="post">
