            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-outline card-olive">
                        <form action="<?= base_url('admin/edit_aset/') . $get_aset['id_input_aset']; ?>" method="post">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <a href="<?= base_url('admin/hasil_input_aset'); ?>" type="button" class="btn  btn-warning btn-sm"><i class="fas fa-step-backward"></i> Hasil Inputan</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
