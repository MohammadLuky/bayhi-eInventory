...
<tr>
    <td colspan="6" class="text-center">
        <div class="col-md-2">
            <a style="display: inline-block; margin:auto;" href="<?= base_url('admin/laporanRekapKondisi/') . $get_subUnit['id_sub_unit']; ?>" class="btn bg-gradient-dark btn-block btn-sm"><i class="fas fa-file-pdf"></i> Cetak Laporan</a>
        </div>
    </td>
</tr>