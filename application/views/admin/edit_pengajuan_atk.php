                ...
                <div class="col-md-12">
                    ...
                    <div class="col-12">
                        <div class="card card-outline card-olive shadow">
                            <form action="<?= base_url('admin/edit_pengajuanATK/') . $GetPengajuan['id_pengajuan']; ?>" method="post">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <a href="<?= base_url('admin/PengajuanATK'); ?>" type="button" class="btn bg-gradient-dark btn-sm"><i class="fas fa-list-alt"></i> Data Pengajuan</a> |
