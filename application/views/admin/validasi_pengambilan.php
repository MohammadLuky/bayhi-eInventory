                            ...
                            <div class="card-body">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="unit_validasi_pengambilan" id="unit_validasi_pengambilan" style="width: 100%;">
    ...
    <div id="ajukan_pengambilanATK<?= $pengambilanATK['id_pengambilan']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ajukan_pengambilanATK" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/approve_pengambilanATK/') . $pengambilanATK['id_pengambilan']; ?>" method="post">
