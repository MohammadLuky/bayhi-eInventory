                        ...
                        <div class="card card-olive shadow ">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <a href="<?= base_url('admin/stokATK') ?>" class="text-dark btn bg-gradient-warning btn-sm"><i class="far fa-list-alt"></i> Daftar Stok ATK</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
    ...
    <div id="hapuspembelianATK<?= $stok['id_history_beli']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="hapuspembelianATK" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/hapuspembelianATK/') . $stok['id_history_beli']; ?>" method="post">
