                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card card-outline card-lightblue shadow">
                                    ...
                                    <div class="card-body">
                                        <?= form_open_multipart('admin/UploadBarangATK'); ?>
                                        <div class="row">
                                            <div class="col-sm-12">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a href="<?= base_url('admin/stokATK') ?>" class="btn bg-gradient-warning text-dark btn-sm"><i class="fas fa-database"></i> Stok ATK</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
...
<div class="modal fade tambah_atk" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?= base_url('admin/atk'); ?>" method="post">
...
<?php foreach ($BarangATK as $atk) : ?>
    <div class="modal fade edit_atk<?= $atk['id_atk']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="<?= base_url('admin/edit_atk/') . $atk['id_atk']; ?>" method="post">
                    <div class="modal-header">
    ...
    <div id="hapus_atk<?= $atk['id_atk']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="hapus_atkTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/hapus_atk/') . $atk['id_atk']; ?>" method="post">
                    <div class="modal-body">
