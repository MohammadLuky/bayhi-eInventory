                    ...
                    <?php if ($getUnit['status_pengajuan'] == 'pengajuan' || $getUnit['status_pengajuan'] == 'revisi') : ?>
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('admin/prosesValidasi/') . $getUnit['id_unit']; ?>" method="post">
                                        <div class="col-12">
                        ...
                        <div class="card card-olive shadow ">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <a href="<?= base_url('admin/DataValidasiPengajuanATK'); ?>" type="button" class="btn bg-gradient-dark btn-sm"><i class="fas fa-step-backward"></i> Kembali</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <?php if ($getUnit['status_pengajuan'] == 'approval') : ?>
                                            <a href="<?= base_url('admin/cetakExcelPengajuanATKUnit/') . $getUnit['id_unit']; ?>" type="button" class="btn bg-gradient-orange btn-sm"><i class="fas fa-print"></i> Cetak Pengajuan</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="proses_pengajuan<?= $ATKunit['id_unit']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="proses_pengajuan" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/prosesPengajuan/') . $getUnit['id_unit']; ?>" method="post">
