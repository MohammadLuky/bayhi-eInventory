                                            ...
                                            <tr>
                                                ...
                                                <?php elseif ($unit['status_pengajuan'] == 'pengisian') : ?>
                                                    <td class="text-center align-middle">
                                                        <a href="<?= base_url('admin/detail_pengajuanATKUnit/') . $unit['id_unit'] ?>" class="badge bg-warning"><i class="fas fa-spinner fa-spin"></i> Proses Pengisian
                                                        </a>
                                                    </td>
                                                <?php elseif ($unit['status_pengajuan'] == 'pengajuan') : ?>
                                                    <td class="text-center align-middle">
                                                        <a href="<?= base_url('admin/detail_pengajuanATKUnit/') . $unit['id_unit'] ?>" class="badge bg-info"><i class="fas fa-info-circle"></i> Detail
                                                        </a>
                                                    </td>
                                                ...
                                                <?php elseif ($unit['status_pengajuan'] == 'approval') : ?>
                                                    <td class="text-center align-middle">
                                                        <a href="<?= base_url('admin/detail_pengajuanATKUnit/') . $unit['id_unit'] ?>" class="badge bg-info"><i class="fas fa-info-circle"></i> Detail - Approval
                                                        </a>
                                                    </td>
                                                <?php endif; ?>
                                            </tr>
