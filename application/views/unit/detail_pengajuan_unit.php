                                            ...
                                            <table class="table table-sm">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <?php if ($getUnit['status_pengajuan'] == 'revisi') : ?>
                                                            <td>
                                                                <strong class="text-danger"><em><?= $getUnit['status_pengajuan']; ?></em></strong>
                                                            </td>
                                                        <?php else : ?>
                                                            <td>
                                                                <strong><em><?= $getUnit['status_pengajuan']; ?></em></strong>
                                                            </td>
                                                        <?php endif; ?>
                                                    </tr>
                                                    <tr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <?php if ($getUnit['status_pengajuan'] == 'approval') : ?>
                                            <a href="<?= base_url('unit/cetakExcelPengajuanATKUnit/') . $getUnit['id_unit']; ?>" type="button" class="btn bg-gradient-orange btn-sm"><i class="fas fa-print"></i> Cetak Pengajuan</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="proses_pengajuan<?= $ATKunit['id_unit']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="proses_pengajuan" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('unit/prosesPengajuan/') . $getUnit['id_unit']; ?>" method="post">
